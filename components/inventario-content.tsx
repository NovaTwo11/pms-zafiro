...
import { Plus, Search, AlertTriangle, Package, TrendingDown, Eye, Trash2, ImageIcon } from "lucide-react"
...
export function InventarioContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Inventory Table - Added View button */}
                ...
                return (
                  <tr
                    ...
                    className={cn(
                      ...
                      isLowStock ? "bg-[#F59E0B]/5" : "hover:bg-[#252525]",
                    )}
                  >
                    ...
                    <td className="px-4 py-4">
                      <Button
                        ...
                        className="border-[#333333] text-[#A3A3A3] hover:text-[#E5E5E5] hover:bg-[#252525] bg-transparent transition-all duration-300"
                      >
        ...
        <DialogContent className="sm:max-w-[500px] bg-[#1A1A1A] border-[#333333]">
          ...
          {selectedProduct && (
            <div className="space-y-6 pt-4">
              {/* Product Image */}
              <div className="aspect-square w-48 mx-auto rounded-lg bg-[#0F0F0F] border border-[#333333] overflow-hidden flex items-center justify-center">
                {selectedProduct.image ? (
                  ...
                  <ImageIcon className="h-16 w-16 text-[#333333]" />
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-[#0F0F0F] border border-[#333333]">
                  <p className="text-xs text-[#A3A3A3]">Stock Actual</p>
                  <p
                    className={cn(
                      "text-xl font-semibold",
                      selectedProduct.stock <= selectedProduct.minStock ? "text-[#F59E0B]" : "text-[#E5E5E5]",
                    )}
                  >
                ...
                <div className="p-4 rounded-lg bg-[#0F0F0F] border border-[#333333]">
                  <p className="text-xs text-[#A3A3A3]">Stock Mínimo</p>
                  <p className="text-xl font-semibold text-[#E5E5E5]">
                    {selectedProduct.minStock} {selectedProduct.unit}
                  </p>
                </div>
                <div className="p-4 rounded-lg bg-[#0F0F0F] border border-[#333333]">
                  <p className="text-xs text-[#A3A3A3]">Costo</p>
                  <p className="text-xl font-semibold text-[#A3A3A3]">{formatCurrency(selectedProduct.cost)}</p>
                </div>
                <div className="p-4 rounded-lg bg-[#0F0F0F] border border-[#333333]">
                  <p className="text-xs text-[#A3A3A3]">Precio Venta</p>
                  <p className="text-xl font-semibold text-[#D4AF37]">{formatCurrency(selectedProduct.price)}</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  className="flex-1 border-[#CF6679] text-[#CF6679] hover:bg-[#CF6679]/10 bg-transparent transition-all duration-300"
                >
          ...
          <div className="space-y-4 pt-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => setNewProductData({ ...newProductData, category: v })}
                >
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent className="bg-[#1A1A1A] border-[#333333]">
                    <SelectItem value="unidades" className="text-[#E5E5E5] focus:bg-[#252525]">
                      Unidades
                    </SelectItem>
                    <SelectItem value="botellas" className="text-[#E5E5E5] focus:bg-[#252525]">
                      Botellas
                    </SelectItem>
                    <SelectItem value="paquetes" className="text-[#E5E5E5] focus:bg-[#252525]">
                      Paquetes
                    </SelectItem>
                    <SelectItem value="galones" className="text-[#E5E5E5] focus:bg-[#252525]">
                      Galones
                    </SelectItem>
                    <SelectItem value="kits" className="text-[#E5E5E5] focus:bg-[#252525]">
                      Kits
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setNewProductData({ ...newProductData, stock: Number.parseInt(e.target.value) })}
                  className="bg-[#0F0F0F] border-[#333333] text-[#E5E5E5] focus:border-[#D4AF37] transition-all duration-300"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setNewProductData({ ...newProductData, minStock: Number.parseInt(e.target.value) })}
                  className="bg-[#0F0F0F] border-[#333333] text-[#E5E5E5] focus:border-[#D4AF37] transition-all duration-300"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setNewProductData({ ...newProductData, cost: Number.parseInt(e.target.value) })}
                  className="bg-[#0F0F0F] border-[#333333] text-[#E5E5E5] focus:border-[#D4AF37] transition-all duration-300"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setNewProductData({ ...newProductData, price: Number.parseInt(e.target.value) })}
                  className="bg-[#0F0F0F] border-[#333333] text-[#E5E5E5] focus:border-[#D4AF37] transition-all duration-300"
                />
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button
                ...
                disabled={!newProductData.name || !newProductData.category}
